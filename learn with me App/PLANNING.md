...
- Home redesign: age pills, stat chips, themed bg, module completion indicators
...
| 13 — Full Offline | Service worker caching + GitHub Pages | 🔲 Backlog |
...
2. Claude API — wire Math + Engineering + add error handling
3. Spaced repetition (SM2) — replace basic 2× weighting
4. MediaPipe Hands — finger counting + gesture control
5. GitHub Pages + full offline caching
6. Parent Dashboard — weekly summary, problem letters
7. Nikud toggle (hide for 7–8 age group)
8. Pre-recorded audio fallback (22 letters + numbers 1–10)
